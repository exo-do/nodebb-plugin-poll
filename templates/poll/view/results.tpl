...
<div class="poll-view-result" data-poll-result="{options.id}">
    <h4>{options.title} <small class="pull-right"><a class="poll-view-result-votecount" href="#">{options.votecount} votos</a></small><!--<span class="pull-right badge poll-view-result-percentage">{options.percentage}%</span>--></h4>
    <div class="progress">
